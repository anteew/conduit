...
function sendError(ws, code, message, closeCode, codec) {
    try {
...
function encodeFrame(obj, codec) {
...
function recordCodecMetrics(codecName, operation, success) {
...
export function startWs(client, port = 9088, bind = '127.0.0.1', codecRegistry) {
    initWsLogStream();
